    ...
    <article className="loginParent">
      <div className="loginWrapper">
        <div className="piktor-gotab">
          <div className="content__left--logo">
            <img src={piktorLogo} alt="piktorLogo" className="piktor-logo" />
          </div>
          <div className="content__left--gotab">Gotab</div>
        </div>
        <div className="input-field">
          <input
            className="input-default form__input loginPage"
        ...
        {invalidLoginId ? (
          <div className="invalid-login">Incorrect username or password.</div>
        ) : (
          ""
        )}
        <div className="btnContainer">
          <div
            className={`loginButn ${
              disableSubmit ? "btn-disable" : "btn-enable"
            }`}
            id="submit"
